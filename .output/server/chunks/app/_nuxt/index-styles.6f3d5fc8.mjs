...
const columnLayout_vue_vue_type_style_index_0_scoped_90b035e7_lang = "section ul[data-v-90b035e7]{display:grid;gap:20px;grid-template-columns:1fr 1fr 1fr}@media (max-width:768px){section ul[data-v-90b035e7]{overflow:auto}section ul li[data-v-90b035e7]{flex:0 0 80%}}.card-title[data-v-90b035e7]{font-weight:700;line-height:1.8;margin-top:10px}";
...
const indexStyles_6f3d5fc8 = [intro_vue_vue_type_style_index_0_scoped_f5e4090c_lang, ourServices_vue_vue_type_style_index_0_scoped_65df56cd_lang, whoAreWe_vue_vue_type_style_index_0_scoped_8e8cbcf6_lang, story_vue_vue_type_style_index_0_scoped_dd508f96_lang, columnLayout_vue_vue_type_style_index_0_scoped_90b035e7_lang, gridsLayout_vue_vue_type_style_index_0_scoped_1c392809_lang, index_vue_vue_type_style_index_0_lang, index_vue_vue_type_style_index_0_lang];

export { indexStyles_6f3d5fc8 as default };
//# sourceMappingURL=index-styles.6f3d5fc8.mjs.map
