...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-eca131de><div class="top-navbar" data-v-eca131de><div class="mobile-only" data-v-eca131de><p class="left" data-v-eca131de><i class="fa-regular fa-magnifying-glass" data-v-eca131de></i></p><p class="right" data-v-eca131de><i class="fa-regular fa-bars" data-v-eca131de></i></p></div><div class="logo" data-v-eca131de><img${ssrRenderAttr("src", _imports_0$1)} data-v-eca131de></div><h1 data-v-eca131de>${ssrInterpolate(_ctx.$t("slogan"))}</h1>`);
      ...
      _push(`</div><div class="navbar is-hidden-mobile" data-v-eca131de><div class="navbar-start" data-v-eca131de><ul data-v-eca131de><li class="has-dropdown" data-v-eca131de><a class="hoverable" data-v-eca131de>${ssrInterpolate(_ctx.$t("products"))}<i class="fa-light fa-angle-down" data-v-eca131de></i><ul class="dropdown" data-v-eca131de><li data-v-eca131de>`);
      ...
      _push(`</li></ul></a></li><li class="has-dropdown" data-v-eca131de><a class="hoverable" data-v-eca131de>${ssrInterpolate(_ctx.$t("navbar_learning"))} <i class="fa-light fa-angle-down" data-v-eca131de></i><ul class="dropdown" data-v-eca131de><!--[-->`);
      ssrRenderList(unref(learing), (o, index) => {
        _push(`<li data-v-eca131de>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: { path: "/category", query: { is: `${o.name}` } }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<!--]--></ul></a></li><li data-v-eca131de><a data-v-eca131de>${ssrInterpolate(_ctx.$t("navbar_tsns"))}</a></li><li data-v-eca131de><a data-v-eca131de>${ssrInterpolate(_ctx.$t("navbar_wing"))}</a></li><li data-v-eca131de>`);
      ...
      _push(`</li></ul></div><div class="navbar-end" data-v-eca131de><input type="text"${ssrRenderAttr("value", unref(search))} class="input small"${ssrRenderAttr("placeholder", _ctx.$t("search"))} data-v-eca131de><hr class="v" data-v-eca131de><p class="lang-switch" data-v-eca131de><a class="${ssrRenderClass([{ current: unref(enStatus) }])}" data-v-eca131de>EN</a><a class="${ssrRenderClass([{ current: unref(laoStatus) }])}" data-v-eca131de>LA</a></p><hr class="v" data-v-eca131de><div class="button-groups" data-v-eca131de><button class="button small" data-v-eca131de>${ssrInterpolate(_ctx.$t("login"))}</button><button class="button main small" data-v-eca131de>${ssrInterpolate(_ctx.$t("register"))}</button></div></div></div></div>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-eca131de"]]);
...
//# sourceMappingURL=main-c5af8896.mjs.map
