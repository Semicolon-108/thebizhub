...
const story_vue_vue_type_style_index_0_scoped_610446b3_lang = "section[data-v-610446b3]{background-image:url(" + buildAssetsURL("footer-bg.f96727d2.svg") + ");background-position:50%}section .section-title[data-v-610446b3]{color:#fff}section ul[data-v-610446b3]{display:flex;gap:20px}@media (max-width:768px){section ul[data-v-610446b3]{overflow:auto}section ul li[data-v-610446b3]{flex:0 0 80%}}";
...
const indexStyles_d5d518bd = [intro_vue_vue_type_style_index_0_scoped_f5e4090c_lang, ourServices_vue_vue_type_style_index_0_scoped_66f6b2d5_lang, whoAreWe_vue_vue_type_style_index_0_scoped_3e09e399_lang, story_vue_vue_type_style_index_0_scoped_610446b3_lang, columnLayout_vue_vue_type_style_index_0_scoped_8e7f1306_lang, gridsLayout_vue_vue_type_style_index_0_scoped_24467dda_lang, index_vue_vue_type_style_index_0_lang, index_vue_vue_type_style_index_0_lang];

export { indexStyles_d5d518bd as default };
//# sourceMappingURL=index-styles.d5d518bd.mjs.map
