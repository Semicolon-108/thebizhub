...
const story_vue_vue_type_style_index_0_scoped_6e7c86d3_lang = "section[data-v-6e7c86d3]{background-image:url(" + buildAssetsURL("footer-bg.f96727d2.svg") + ");background-position:50%}section .section-title[data-v-6e7c86d3]{color:#fff}section ul[data-v-6e7c86d3]{display:flex;gap:20px}@media (max-width:768px){section ul[data-v-6e7c86d3]{overflow:auto}section ul li[data-v-6e7c86d3]{flex:0 0 80%}}";

const columnLayout_vue_vue_type_style_index_0_scoped_0d90d7c3_lang = "ul[data-v-0d90d7c3]{display:grid;gap:20px;grid-template-columns:1fr 1fr 1fr}@media (max-width:768px){ul[data-v-0d90d7c3]{overflow:auto}ul li[data-v-0d90d7c3]{flex:0 0 80%}}.card-title[data-v-0d90d7c3]{font-weight:700;line-height:1.8;margin-top:10px}";

const gridsLayout_vue_vue_type_style_index_0_scoped_431a866b_lang = "ul[data-v-431a866b]{display:grid;gap:20px;grid-template-columns:repeat(17,1fr)}@media (max-width:768px){ul[data-v-431a866b]{grid-template-columns:1fr}}ul li[data-v-431a866b]:first-child{grid-column:span 8;grid-row:span 2}@media (max-width:768px){ul li[data-v-431a866b]:first-child{grid-column:span 17;grid-template-columns:1fr}}ul li[data-v-431a866b]:not(:first-child){grid-column:span 4}@media (max-width:768px){ul li[data-v-431a866b]:not(:first-child){grid-column:span 17;grid-template-columns:1fr}}.card-title[data-v-431a866b]{font-weight:700;line-height:1.8;margin-top:10px}";
...
const indexStyles_ba675458 = [intro_vue_vue_type_style_index_0_scoped_1f47b4b6_lang, ourServices_vue_vue_type_style_index_0_scoped_533ab5d4_lang, whoAreWe_vue_vue_type_style_index_0_scoped_8e8cbcf6_lang, story_vue_vue_type_style_index_0_scoped_6e7c86d3_lang, columnLayout_vue_vue_type_style_index_0_scoped_0d90d7c3_lang, gridsLayout_vue_vue_type_style_index_0_scoped_431a866b_lang, index_vue_vue_type_style_index_0_lang, index_vue_vue_type_style_index_0_lang];

export { indexStyles_ba675458 as default };
//# sourceMappingURL=index-styles.ba675458.mjs.map
