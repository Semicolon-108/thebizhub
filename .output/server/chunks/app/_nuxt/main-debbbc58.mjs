...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-db8094c1><div class="top-navbar" data-v-db8094c1><div class="mobile-only" data-v-db8094c1><p class="left" data-v-db8094c1><i class="fa-regular fa-magnifying-glass" data-v-db8094c1></i></p><p class="right" data-v-db8094c1><i class="fa-regular fa-bars" data-v-db8094c1></i></p></div><div class="logo" data-v-db8094c1><img${ssrRenderAttr("src", _imports_0)} data-v-db8094c1></div><h1 data-v-db8094c1>${ssrInterpolate(_ctx.$t("slogan"))}</h1>`);
      ...
      _push(`</div><div class="navbar is-hidden-mobile" data-v-db8094c1><div class="navbar-start" data-v-db8094c1><ul data-v-db8094c1><li class="has-dropdown" data-v-db8094c1><a class="hoverable" data-v-db8094c1>${ssrInterpolate(_ctx.$t("navbar_learning"))} <i class="fa-light fa-angle-down" data-v-db8094c1></i><ul class="dropdown" data-v-db8094c1><!--[-->`);
      ssrRenderList(unref(learing), (o, index) => {
        _push(`<li data-v-db8094c1>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: { path: "/category", query: { is: `${o.name}` } }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<!--]--></ul></a></li><li data-v-db8094c1><a data-v-db8094c1>${ssrInterpolate(_ctx.$t("navbar_tsns"))}</a></li><li data-v-db8094c1><a data-v-db8094c1>${ssrInterpolate(_ctx.$t("navbar_wing"))}</a></li><li data-v-db8094c1><a data-v-db8094c1>${ssrInterpolate(_ctx.$t("article_events"))}</a></li><li data-v-db8094c1><a href="https://docs.google.com/forms/d/e/1FAIpQLSfsRhORbsNje2WzOdWGCLJAdKuyEGDlUejL2qr4e-gzencLcw/viewform" target="_blank" data-v-db8094c1>${ssrInterpolate(_ctx.$t("navbar_partner_with_us"))}</a></li><li data-v-db8094c1><a data-v-db8094c1>${ssrInterpolate(_ctx.$t("navbar_bussiness_supporter"))}</a></li><li data-v-db8094c1>`);
      ...
      _push(`</li></ul></div><div class="navbar-end" data-v-db8094c1><input type="text"${ssrRenderAttr("value", unref(search))} class="input small"${ssrRenderAttr("placeholder", _ctx.$t("search"))} data-v-db8094c1><hr class="v" data-v-db8094c1><p class="lang-switch" data-v-db8094c1><a class="${ssrRenderClass([{ current: unref(laoStatus) }])}" data-v-db8094c1>LA</a><a class="${ssrRenderClass([{ current: unref(enStatus) }])}" data-v-db8094c1>EN</a></p><hr class="v" data-v-db8094c1><div class="button-groups" data-v-db8094c1>`);
      if (unref(authStatus)) {
        _push(`<button class="button small" data-v-db8094c1>${ssrInterpolate(_ctx.$t("logout"))}</button>`);
      } else {
        _push(`<button class="button small" data-v-db8094c1>${ssrInterpolate(_ctx.$t("login"))}</button>`);
      }
      if (!unref(authStatus)) {
        _push(`<button class="button main small" data-v-db8094c1>${ssrInterpolate(_ctx.$t("register"))}</button>`);
      } else {
        _push(`<!---->`);
      }
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-db8094c1"]]);
...
//# sourceMappingURL=main-debbbc58.mjs.map
