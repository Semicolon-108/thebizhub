...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-3872b947><div class="top-navbar" data-v-3872b947><div class="mobile-only" data-v-3872b947><p class="left" data-v-3872b947><i class="fa-regular fa-magnifying-glass" data-v-3872b947></i></p><p class="right" data-v-3872b947><i class="fa-regular fa-bars" data-v-3872b947></i></p></div><div class="logo" data-v-3872b947><img${ssrRenderAttr("src", _imports_0$1)} data-v-3872b947></div><h1 data-v-3872b947>${ssrInterpolate(_ctx.$t("slogan"))}</h1>`);
      ...
      _push(`</div><div class="navbar is-hidden-mobile" data-v-3872b947><div class="navbar-start" data-v-3872b947><ul data-v-3872b947><li class="has-dropdown" data-v-3872b947><a class="hoverable" data-v-3872b947>${ssrInterpolate(_ctx.$t("products"))}<i class="fa-light fa-angle-down" data-v-3872b947></i><ul class="dropdown" data-v-3872b947><li data-v-3872b947>`);
      ...
      _push(`</li></ul></a></li><li class="has-dropdown" data-v-3872b947><a class="hoverable" data-v-3872b947>${ssrInterpolate(_ctx.$t("learning"))} <i class="fa-light fa-angle-down" data-v-3872b947></i><ul class="dropdown" data-v-3872b947><!--[-->`);
      ssrRenderList(unref(learing), (o, index) => {
        _push(`<li data-v-3872b947>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: { path: "/category", query: { is: `${o.name}` } }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<!--]--></ul></a></li><li data-v-3872b947><a data-v-3872b947>${ssrInterpolate(_ctx.$t("article_tsns"))}</a></li><li data-v-3872b947><a data-v-3872b947>${ssrInterpolate(_ctx.$t("article_wing"))}</a></li><li data-v-3872b947>`);
      ...
      _push(`</li></ul></div><div class="navbar-end" data-v-3872b947><input type="text"${ssrRenderAttr("value", unref(search))} class="input small"${ssrRenderAttr("placeholder", _ctx.$t("search"))} data-v-3872b947><hr class="v" data-v-3872b947><p class="lang-switch" data-v-3872b947><a class="${ssrRenderClass([{ current: unref(enStatus) }])}" data-v-3872b947>EN</a><a class="${ssrRenderClass([{ current: unref(laoStatus) }])}" data-v-3872b947>LA</a></p><hr class="v" data-v-3872b947><div class="button-groups" data-v-3872b947><button class="button small" data-v-3872b947>${ssrInterpolate(_ctx.$t("login"))}</button><button class="button main small" data-v-3872b947>${ssrInterpolate(_ctx.$t("register"))}</button></div></div></div></div>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3872b947"]]);
...
//# sourceMappingURL=main-97e1f29d.mjs.map
