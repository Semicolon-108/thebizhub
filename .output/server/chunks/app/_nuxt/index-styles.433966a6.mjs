...
const intro_vue_vue_type_style_index_0_scoped_20849af3_lang = ".left[data-v-20849af3]{align-items:center;display:flex}@media (max-width:768px){.left[data-v-20849af3]{text-align:center}}.left .intro h1[data-v-20849af3]{font-size:3rem;font-weight:700}@media (max-width:768px){.left .intro h1[data-v-20849af3]{line-height:1.5}}.left .intro h3[data-v-20849af3]{font-size:1.8rem;font-weight:600;line-height:1.3}@media (max-width:768px){.left .intro h3[data-v-20849af3]{font-size:1.5rem;margin-top:10px}}.right .video[data-v-20849af3]{width:100%}.right .video iframe[data-v-20849af3]{aspect-ratio:16/9;display:block;width:100%}";

const ourServices_vue_vue_type_style_index_0_scoped_b6699a4a_lang = '.section[data-v-b6699a4a]{position:relative}.section[data-v-b6699a4a]:before{background-color:var(--sub-color);content:"";display:block;height:200px;left:0;position:absolute;right:0;top:0;z-index:1}.section .section-header[data-v-b6699a4a]{margin-bottom:20px;position:relative;z-index:2}.section .section-header .section-title[data-v-b6699a4a]{color:#fff;text-align:center}.section .section-body[data-v-b6699a4a]{position:relative;z-index:2}.section .section-body .card[data-v-b6699a4a]{background-color:#fff;border:1px solid var(--border-color);border-radius:6px;height:100%;padding:30px;text-align:center}.section .section-body .card .card-icon[data-v-b6699a4a]{display:flex;justify-content:center;margin-bottom:20px}.section .section-body .card .card-icon img[data-v-b6699a4a]{display:block;-o-object-fit:cover;object-fit:cover;width:80px}.section .section-body .card .card-title[data-v-b6699a4a]{font-size:var(--md-font);font-weight:700;margin-bottom:5px;position:relative;text-align:center;text-transform:uppercase}.section .section-body .card .card-title[data-v-b6699a4a]:after{background-color:var(--sub-color);border-radius:3px;content:"";display:block;height:3px;margin:.5rem auto;width:30px}.section .section-body .card p[data-v-b6699a4a]{font-size:var(--md-font)}.section .section-body button[data-v-b6699a4a]{margin-top:10px}';
...
const index_vue_vue_type_style_index_0_lang = "section{padding:3rem 2rem}@media (max-width:768px){section{padding:2rem 1rem}}section.tsns-bg{background-image:url(" + buildAssetsURL("tsns-bg.0658f6fe.jpg") + ")}section.tsns-bg,section.wing-bg{background-position:cover;background-size:cover;color:#fff}section.wing-bg{background-image:url(" + buildAssetsURL("wing-bg.df7719e6.jpg") + ")}.container{line-height:1.5;margin-left:auto;margin-right:auto;max-width:1024px}.section-title{font-size:var(--xlg-font);font-weight:700;margin-bottom:10px;text-transform:uppercase}";

const indexStyles_433966a6 = [intro_vue_vue_type_style_index_0_scoped_20849af3_lang, ourServices_vue_vue_type_style_index_0_scoped_b6699a4a_lang, whoAreWe_vue_vue_type_style_index_0_scoped_8e8cbcf6_lang, story_vue_vue_type_style_index_0_scoped_dd508f96_lang, columnLayout_vue_vue_type_style_index_0_scoped_15360664_lang, gridsLayout_vue_vue_type_style_index_0_scoped_1c392809_lang, index_vue_vue_type_style_index_0_lang, index_vue_vue_type_style_index_0_lang];

export { indexStyles_433966a6 as default };
//# sourceMappingURL=index-styles.433966a6.mjs.map
