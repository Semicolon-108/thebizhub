...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-1353b3f1><div class="top-navbar" data-v-1353b3f1><div class="mobile-only" data-v-1353b3f1><p class="left" data-v-1353b3f1><i class="fa-regular fa-magnifying-glass" data-v-1353b3f1></i></p><p class="right" data-v-1353b3f1><i class="fa-regular fa-bars" data-v-1353b3f1></i></p></div><div class="logo" data-v-1353b3f1><img${ssrRenderAttr("src", _imports_0$1)} data-v-1353b3f1></div><h1 data-v-1353b3f1>${ssrInterpolate(_ctx.$t("slogan"))}</h1>`);
      ...
      _push(`</div><div class="navbar is-hidden-mobile" data-v-1353b3f1><div class="navbar-start" data-v-1353b3f1><ul data-v-1353b3f1><li class="has-dropdown" data-v-1353b3f1><a class="hoverable" data-v-1353b3f1>${ssrInterpolate(_ctx.$t("navbar_learning"))} <i class="fa-light fa-angle-down" data-v-1353b3f1></i><ul class="dropdown" data-v-1353b3f1><!--[-->`);
      ssrRenderList(unref(learing), (o, index) => {
        _push(`<li data-v-1353b3f1>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: { path: "/category", query: { is: `${o.name}` } }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<!--]--></ul></a></li><li data-v-1353b3f1><a data-v-1353b3f1>${ssrInterpolate(_ctx.$t("navbar_tsns"))}</a></li><li data-v-1353b3f1><a data-v-1353b3f1>${ssrInterpolate(_ctx.$t("navbar_wing"))}</a></li><li data-v-1353b3f1><a data-v-1353b3f1>${ssrInterpolate(_ctx.$t("article_events"))}</a></li><li data-v-1353b3f1>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/about-us" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("navbar_partner"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("navbar_partner")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li><li data-v-1353b3f1>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/about-us" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("navbar_donate"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("navbar_donate")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul></div><div class="navbar-end" data-v-1353b3f1><input type="text"${ssrRenderAttr("value", unref(search))} class="input small"${ssrRenderAttr("placeholder", _ctx.$t("search"))} data-v-1353b3f1><hr class="v" data-v-1353b3f1><p class="lang-switch" data-v-1353b3f1><a class="${ssrRenderClass([{ current: unref(enStatus) }])}" data-v-1353b3f1>EN</a><a class="${ssrRenderClass([{ current: unref(laoStatus) }])}" data-v-1353b3f1>LA</a></p><hr class="v" data-v-1353b3f1><div class="button-groups" data-v-1353b3f1><button class="button small" data-v-1353b3f1>${ssrInterpolate(_ctx.$t("login"))}</button><button class="button main small" data-v-1353b3f1>${ssrInterpolate(_ctx.$t("register"))}</button></div></div></div></div>`);
    };
  }
});
const Navbar_vue_vue_type_style_index_0_scoped_1353b3f1_lang = "";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1353b3f1"]]);
...
//# sourceMappingURL=main-7e9940df.js.map
