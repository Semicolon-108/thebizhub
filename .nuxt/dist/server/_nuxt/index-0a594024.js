...
import { defineComponent, ref, watch, mergeProps, useSSRContext, unref, withCtx, createVNode, toDisplayString } from "vue";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-6e7c86d3><div class="container" data-v-6e7c86d3><h1 class="section-title" data-v-6e7c86d3>${ssrInterpolate(__props.title)} `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: { path: "/category", query: { is: `${__props.title}` } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="main margin-top-20" data-v-6e7c86d3${_scopeId}>${ssrInterpolate(_ctx.$t("more"))}</button>`);
          } else {
            return [
              createVNode("button", { class: "main margin-top-20" }, toDisplayString(_ctx.$t("more")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</h1><ul data-v-6e7c86d3><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-6e7c86d3><div class="card dark" data-v-6e7c86d3><div class="card-image" data-v-6e7c86d3><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-6e7c86d3></div><div class="card-content" data-v-6e7c86d3><h3 data-v-6e7c86d3>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
      _push(`<!--]--></ul></div></section>`);
    };
  }
});
const story_vue_vue_type_style_index_0_scoped_6e7c86d3_lang = "";
...
const Story = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-6e7c86d3"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-0d90d7c3><h1 class="section-title" data-v-0d90d7c3>${ssrInterpolate(__props.title)} `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: { path: "/category", query: { is: `${__props.title}` } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="main margin-top-20" data-v-0d90d7c3${_scopeId}>${ssrInterpolate(_ctx.$t("more"))}</button>`);
          } else {
            return [
              createVNode("button", { class: "main margin-top-20" }, toDisplayString(_ctx.$t("more")), 1)
            ];
      ...
      _push(`</h1><ul data-v-0d90d7c3><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-0d90d7c3><div class="card" data-v-0d90d7c3><div class="card-image fullheight" data-v-0d90d7c3><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-0d90d7c3></div><div class="card-content" data-v-0d90d7c3><h3 class="card-title" data-v-0d90d7c3>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
      _push(`<!--]--></ul></div>`);
    };
  }
});
const columnLayout_vue_vue_type_style_index_0_scoped_0d90d7c3_lang = "";
...
const BusinessSupporters = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-0d90d7c3"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-431a866b><div class="container" data-v-431a866b><h1 class="section-title" data-v-431a866b>${ssrInterpolate(__props.title)} `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: { path: "/category", query: { is: `${__props.title}` } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button class="main margin-top-20" data-v-431a866b${_scopeId}>${ssrInterpolate(_ctx.$t("more"))}</button>`);
          } else {
            return [
              createVNode("button", { class: "main margin-top-20" }, toDisplayString(_ctx.$t("more")), 1)
            ];
      ...
      _push(`</h1><ul data-v-431a866b><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-431a866b><div class="card" data-v-431a866b><div class="card-image" data-v-431a866b><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-431a866b></div><div class="card-content" data-v-431a866b><h3 class="card-title" data-v-431a866b>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
      _push(`<!--]--></ul></div></section>`);
    };
  }
});
const gridsLayout_vue_vue_type_style_index_0_scoped_431a866b_lang = "";
...
const TricksAndTips = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-431a866b"]]);
...
//# sourceMappingURL=index-0a594024.js.map
