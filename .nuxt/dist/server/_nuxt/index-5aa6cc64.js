...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-507457e8><div class="container" data-v-507457e8><h1 class="page-title" data-v-507457e8>${ssrInterpolate(unref(routerName))}</h1>`);
      if (unref(detail)) {
        _push(`<p data-v-507457e8>${ssrInterpolate(unref(detail))}</p>`);
      } else {
        _push(`<!---->`);
      }
...
const index_vue_vue_type_style_index_0_scoped_507457e8_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-507457e8"]]);
export {
  index as default
};
//# sourceMappingURL=index-5aa6cc64.js.map
