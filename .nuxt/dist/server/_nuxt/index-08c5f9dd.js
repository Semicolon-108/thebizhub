...
import ProductAndServcie from "./product-and-services-6bcb9999.js";
import Works from "./works-23fce75c.js";
import { _ as _export_sfc } from "../server.mjs";
import "./project-business-consultancy-b808dbae.js";
import "swiper/vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-3236b544><section data-v-3236b544><div class="container" data-v-3236b544><h1 class="page-title" data-v-3236b544>THE BIZ HUB ແມ່ນຫຍັງ?</h1><div class="grids is-2-desktop is-1-mobile gap-20-desktop" data-v-3236b544><div class="box span-2-desktop" data-v-3236b544><div class="grids is-5-desktop is-1-mobile gap-20-desktop" data-v-3236b544><h1 class="span-2-desktop" data-v-3236b544> PARTNER FOR SUCCESS IN BUSINESS AND ENTREPRENEURSHIP </h1><p class="span-3-desktop" data-v-3236b544> ພວກເຮົາມຸ່ງໝັ້ນໃນການສົ່ງເສີມ ແລະ ເສີມສ້າງຜູ້ປະກອບການລຸ້ນໃໝ່ ໂດຍສະເພາະແມ່ນ ຜູ້ທີ່ກຳລັງຢູ່ໃນຂັ້ນກຽມຕົວ ຫຼື ກຳລັງເລີ່ມຕົ້ນເຮັດທຸລະກິດ ທີ່ຕ້ອງການພັດທະນາຕົນເອງ ແລະ ທຸລະກິດໃຫ້ເຕີບໂຕຢ່າງບໍ່ຢຸດຢັ້ງ. </p></div></div><div class="box" data-v-3236b544><h3 class="margin-bottom-10" data-v-3236b544>ພາລະກິດ ວິໄສທັດ</h3><p data-v-3236b544> ເພື່ອສະໜອງບໍລິການໃຫ້ຄາປຶກສາ,ຂມູນຂ່າວສານ, ການຝຶກອົບຮົມແລະເຄື່ອງມືທີ່ຈາເປນໃນການລິເລີ່ມ ທຸລະກິດໃຫ້ເຂ້ມແຂງ ແລະ ສ້າງການປ່ຽນແປງທີ່ດີ ສູ່ສັງຄົມ. </p></div><div class="box" data-v-3236b544><h3 class="margin-bottom-10" data-v-3236b544>ວິໄສທັດ</h3><p data-v-3236b544> ເປນຂົວຕໃຫ້ກັບບັນດາຜູ້ທີ່ເລີ່ມຕົ້ນເຮດທຸລະກິດສາ ມາດກ້າວໄປສູ່ຄວາມສາເລດ </p></div></div></div></section><img class="top-image"${ssrRenderAttr("src", _imports_0)} data-v-3236b544>`);
      _push(ssrRenderComponent(ProductAndServcie, null, null, _parent));
      _push(`<h1 class="section-title" data-v-3236b544>ຜົນງານຂອງ THE BIZ HUB</h1>`);
      _push(ssrRenderComponent(Works, { work: unref(works) }, null, _parent));
      _push(`</div>`);
    };
  }
});
const index_vue_vue_type_style_index_0_scoped_3236b544_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3236b544"]]);
export {
  index as default
};
//# sourceMappingURL=index-08c5f9dd.js.map
