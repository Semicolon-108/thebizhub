...
const intro_vue_vue_type_style_index_0_scoped_20849af3_lang = "";
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    fetchOurService();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))} data-v-b6699a4a><div class="container" data-v-b6699a4a><div class="section-header" data-v-b6699a4a><div class="section-title" data-v-b6699a4a>${ssrInterpolate(_ctx.$t("products"))}</div></div><div class="section-body" data-v-b6699a4a><ul class="grids is-3-desktop is-1-mobile gap-10-tablet gap-10-tablet gap-20-desktop gap-10-mobile" data-v-b6699a4a><!--[-->`);
      ssrRenderList(unref(info), (i, index) => {
        _push(`<li data-v-b6699a4a><div class="card" data-v-b6699a4a><div class="card-icon" data-v-b6699a4a><img${ssrRenderAttr("src", unref(urlImage) + i.image)} data-v-b6699a4a></div><h3 class="card-title" data-v-b6699a4a>${ssrInterpolate(i.key)}</h3><p data-v-b6699a4a>${ssrInterpolate(i.desc)}</p><button class="button main small" data-v-b6699a4a>More detail</button></div></li>`);
      });
      _push(`<!--]--></ul></div></div></section>`);
    };
  }
});
const ourServices_vue_vue_type_style_index_0_scoped_b6699a4a_lang = "";
...
const OurService = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-b6699a4a"]]);
...
const gridsLayout_vue_vue_type_style_index_0_scoped_1c392809_lang = "";
...
//# sourceMappingURL=index-dacb278f.js.map
