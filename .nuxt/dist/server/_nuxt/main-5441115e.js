...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-92e6d536><div class="top-navbar" data-v-92e6d536><div class="mobile-only" data-v-92e6d536><p class="left" data-v-92e6d536><i class="fa-regular fa-magnifying-glass" data-v-92e6d536></i></p><p class="right" data-v-92e6d536><i class="fa-regular fa-bars" data-v-92e6d536></i></p></div><div class="logo" data-v-92e6d536><img${ssrRenderAttr("src", _imports_0$1)} data-v-92e6d536></div><h1 data-v-92e6d536>${ssrInterpolate(_ctx.$t("slogan"))}</h1>`);
      ...
      _push(`</div><div class="navbar is-hidden-mobile" data-v-92e6d536><div class="navbar-start" data-v-92e6d536><ul data-v-92e6d536><li class="has-dropdown" data-v-92e6d536><a class="hoverable" data-v-92e6d536>${ssrInterpolate(_ctx.$t("navbar_learning"))} <i class="fa-light fa-angle-down" data-v-92e6d536></i><ul class="dropdown" data-v-92e6d536><!--[-->`);
      ssrRenderList(unref(learing), (o, index) => {
        _push(`<li data-v-92e6d536>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: { path: "/category", query: { is: `${o.name}` } }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<!--]--></ul></a></li><li data-v-92e6d536><a data-v-92e6d536>${ssrInterpolate(_ctx.$t("navbar_tsns"))}</a></li><li data-v-92e6d536><a data-v-92e6d536>${ssrInterpolate(_ctx.$t("navbar_wing"))}</a></li><li data-v-92e6d536><a data-v-92e6d536>${ssrInterpolate(_ctx.$t("article_events"))}</a></li><li data-v-92e6d536><a href="https://docs.google.com/forms/d/e/1FAIpQLSfsRhORbsNje2WzOdWGCLJAdKuyEGDlUejL2qr4e-gzencLcw/viewform" target="_blank" data-v-92e6d536>${ssrInterpolate(_ctx.$t("navbar_partner_with_us"))}</a></li><li data-v-92e6d536>`);
      _push(ssrRenderComponent(_component_NuxtLink, { to: "/about-us" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("navbar_bussiness_supporter"))}`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("navbar_bussiness_supporter")), 1)
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</li></ul></div><div class="navbar-end" data-v-92e6d536><input type="text"${ssrRenderAttr("value", unref(search))} class="input small"${ssrRenderAttr("placeholder", _ctx.$t("search"))} data-v-92e6d536><hr class="v" data-v-92e6d536><p class="lang-switch" data-v-92e6d536><a class="${ssrRenderClass([{ current: unref(enStatus) }])}" data-v-92e6d536>EN</a><a class="${ssrRenderClass([{ current: unref(laoStatus) }])}" data-v-92e6d536>LA</a></p><hr class="v" data-v-92e6d536><div class="button-groups" data-v-92e6d536><button class="button small" data-v-92e6d536>${ssrInterpolate(_ctx.$t("login"))}</button><button class="button main small" data-v-92e6d536>${ssrInterpolate(_ctx.$t("register"))}</button></div></div></div></div>`);
    };
  }
});
const Navbar_vue_vue_type_style_index_0_scoped_92e6d536_lang = "";
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-92e6d536"]]);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0$2;
      _push(`<!--[--><section data-v-e1771e64><div class="container" data-v-e1771e64><ul class="grids is-14-desktop is-1-mobile" data-v-e1771e64><li class="span-4-desktop" data-v-e1771e64><div class="logo margin-bottom-10" data-v-e1771e64><img${ssrRenderAttr("src", _imports_0)} alt="" data-v-e1771e64><h3 data-v-e1771e64>THE BIZ HUB</h3></div><small class="margin-bottom-15" data-v-e1771e64>1st Floor, 108Hill Building Dongpaina Road, Saphanthong Village, Sisattanak District, Vientiane Capital, Lao PDR.</small><small data-v-e1771e64>020 56463959 | 020 56508160</small><small data-v-e1771e64>thebizhub.info@gmail.com</small></li><li class="span-5-desktop" data-v-e1771e64><h3 data-v-e1771e64>${ssrInterpolate(_ctx.$t("navbar_learning"))}</h3><ul data-v-e1771e64><!--[-->`);
      ssrRenderList(unref(learing), (o, index) => {
        _push(`<li data-v-e1771e64>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: { path: "/category", query: { is: `${o.name}` } }
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`<!--]--></ul></li><li class="span-5-desktop" data-v-e1771e64><h3 data-v-e1771e64>${ssrInterpolate(_ctx.$t("products"))}</h3><ul data-v-e1771e64><li data-v-e1771e64>`);
      ...
      _push(`</li></ul><div class="socials" data-v-e1771e64><h3 data-v-e1771e64>${ssrInterpolate(_ctx.$t("follow_us"))}</h3><ul data-v-e1771e64><li data-v-e1771e64><a href="https://www.facebook.com/profile.php?id=100091801856212" target="_blank" data-v-e1771e64><i class="fa-brands fa-facebook" data-v-e1771e64></i></a></li><li data-v-e1771e64><a href="https://www.tiktok.com/@thebizhublaos" target="_blank" data-v-e1771e64><i class="fa-brands fa-tiktok" data-v-e1771e64></i></a></li><li data-v-e1771e64><a href="https://www.youtube.com/@TheBIZHUB" target="_blank" data-v-e1771e64><i class="fa-brands fa-youtube" data-v-e1771e64></i></a></li></ul></div></li></ul></div></section><div class="footer" data-v-e1771e64><p data-v-e1771e64> Copyright © 108-1009 Group Co., Ltd. | Designed and Developed by Semicolon Sole Co., Ltd. </p></div><!--]-->`);
    };
  }
});
const Footer_vue_vue_type_style_index_0_scoped_e1771e64_lang = "";
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-e1771e64"]]);
const _sfc_main = {};
...
//# sourceMappingURL=main-5441115e.js.map
