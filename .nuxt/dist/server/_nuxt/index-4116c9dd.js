...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useRouter();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-90b035e7><div class="container" data-v-90b035e7><h1 class="section-title" data-v-90b035e7>${ssrInterpolate(__props.title)}</h1><ul data-v-90b035e7><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-90b035e7><div class="card" data-v-90b035e7><div class="card-image fullheight" data-v-90b035e7><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-90b035e7></div><div class="card-content" data-v-90b035e7><h3 class="card-title" data-v-90b035e7>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
      _push(`<!--]--></ul></div></section>`);
    };
  }
});
const columnLayout_vue_vue_type_style_index_0_scoped_90b035e7_lang = "";
...
const BusinessSupporters = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-90b035e7"]]);
...
const SelftEmployment = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-1c392809"]]);
...
//# sourceMappingURL=index-4116c9dd.js.map
