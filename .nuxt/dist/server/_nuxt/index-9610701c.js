...
import Works from "./works-463d9672.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-9a47496b><div class="container" data-v-9a47496b><section class="section" data-v-9a47496b><h1 class="page-title" data-v-9a47496b>THE BIZ HUB ແມ່ນຫຍັງ?</h1><div class="grids is-2-desktop is-1-mobile gap-20-desktop" data-v-9a47496b><!--[-->`);
      ssrRenderList(unref(tabs), (i, index2) => {
        _push(`<div class="box" data-v-9a47496b><h3 class="margin-bottom-10" data-v-9a47496b>${ssrInterpolate(i.key)}</h3><p data-v-9a47496b>${ssrInterpolate(i.desc)}</p></div>`);
      });
      _push(`<!--]--></div></section></div><img class="top-image"${ssrRenderAttr("src", _imports_0)} data-v-9a47496b>`);
      _push(ssrRenderComponent(ProductAndServcie, null, null, _parent));
      _push(`<h1 class="section-title" data-v-9a47496b>ຜົນງານຂອງ THE BIZ HUB</h1>`);
      _push(ssrRenderComponent(Works, { work: unref(isWork) }, null, _parent));
      _push(`</div>`);
    };
  }
});
const index_vue_vue_type_style_index_0_scoped_9a47496b_lang = "";
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9a47496b"]]);
export {
  index as default
};
//# sourceMappingURL=index-9610701c.js.map
