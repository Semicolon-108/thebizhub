import { u as useRouter, g as useRoute, e as useCookie, _ as _export_sfc, d as useNuxtApp } from "../server.mjs";
import { defineComponent, ref, watch, mergeProps, useSSRContext, unref, withCtx, createVNode, toDisplayString, createTextVNode } from "vue";
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "section" }, _attrs))} data-v-1f47b4b6><div class="container" data-v-1f47b4b6><div class="grids gap-20-desktop is-5-desktop is-1-mobile gap-10-mobile" data-v-1f47b4b6><div class="left span-2-desktop" data-v-1f47b4b6><div class="intro" data-v-1f47b4b6><h1 data-v-1f47b4b6>THE BIZ HUB</h1><h3 data-v-1f47b4b6>${ssrInterpolate(_ctx.$t("partnerforsuccess"))} <br class="is-hidden-mobile" data-v-1f47b4b6> ${ssrInterpolate(_ctx.$t("inBusiness"))} <br class="is-hidden-mobile" data-v-1f47b4b6> ${ssrInterpolate(_ctx.$t("entrepreneurship"))}</h3><button class="main margin-top-20" data-v-1f47b4b6>${ssrInterpolate(_ctx.$t("updates"))}</button></div></div><div class="right span-3-desktop" data-v-1f47b4b6><div class="video" data-v-1f47b4b6><iframe src="https://www.youtube.com/embed/PezSDxa0vrs?si=h07PGaZbGmI8jwC2" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen data-v-1f47b4b6></iframe></div></div></div></div></section>`);
    };
  }
});
const intro_vue_vue_type_style_index_0_scoped_1f47b4b6_lang = "";
...
const Intro = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-1f47b4b6"]]);
...
const whoAreWe_vue_vue_type_style_index_0_scoped_8e8cbcf6_lang = "";
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-8e6aa68f><div class="container" data-v-8e6aa68f><div class="section-header" data-v-8e6aa68f><h1 class="section-title" data-v-8e6aa68f>${ssrInterpolate(__props.title)}</h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: { path: "/category", query: { is: `${__props.title}` } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("more"))}<i class="fa-regular fa-arrow-right" data-v-8e6aa68f${_scopeId}></i>`);
          } else {
            return [
      ...
      _push(`</div><ul data-v-8e6aa68f><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-8e6aa68f><div class="card dark" data-v-8e6aa68f><div class="card-image" data-v-8e6aa68f><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-8e6aa68f></div><div class="card-content" data-v-8e6aa68f><h3 data-v-8e6aa68f>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
...
const Story = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-8e6aa68f"]]);
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container" }, _attrs))} data-v-8fce892e><div class="section-header" data-v-8fce892e><h1 class="section-title" data-v-8fce892e>${ssrInterpolate(__props.title)}</h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: { path: "/category", query: { is: `${__props.title}` } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("more"))}<i class="fa-regular fa-arrow-right" data-v-8fce892e${_scopeId}></i>`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("more")), 1),
              createVNode("i", { class: "fa-regular fa-arrow-right" })
      ...
      _push(`</div><ul data-v-8fce892e><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-8fce892e><div class="card" data-v-8fce892e><div class="card-image fullheight" data-v-8fce892e><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-8fce892e></div><div class="card-content" data-v-8fce892e><h3 class="card-title" data-v-8fce892e>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
      _push(`<!--]--></ul></div>`);
    };
  }
});
const columnLayout_vue_vue_type_style_index_0_scoped_8fce892e_lang = "";
...
const BusinessSupporters = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-8fce892e"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-63177450><div class="container" data-v-63177450><div class="section-header" data-v-63177450><h1 class="section-title" data-v-63177450>${ssrInterpolate(__props.title)}</h1>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: { path: "/category", query: { is: `${__props.title}` } }
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`${ssrInterpolate(_ctx.$t("more"))}<i class="fa-regular fa-arrow-right" data-v-63177450${_scopeId}></i>`);
          } else {
            return [
              createTextVNode(toDisplayString(_ctx.$t("more")), 1),
              createVNode("i", { class: "fa-regular fa-arrow-right" })
      ...
      _push(`</div><ul data-v-63177450><!--[-->`);
      ssrRenderList(__props.info, (i, index) => {
        _push(`<li data-v-63177450><div class="card" data-v-63177450><div class="card-image" data-v-63177450><img${ssrRenderAttr("src", unref(images) + i.coverPage)} alt="" data-v-63177450></div><div class="card-content" data-v-63177450><h3 class="card-title" data-v-63177450>${ssrInterpolate(i.title)}</h3></div></div></li>`);
      });
      _push(`<!--]--></ul></div></section>`);
    };
  }
});
const gridsLayout_vue_vue_type_style_index_0_scoped_63177450_lang = "";
...
const TricksAndTips = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-63177450"]]);
...
//# sourceMappingURL=index-773c5da6.js.map
