...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/gallery-697764f2.js").then((m) => m.default || m)
  },
  {
    name: "about-us",
    path: "/about-us",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-5b60afb4.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/product-and-services-778ec1a1.js").then((m) => m.default || m)
  },
  {
    name: "about-us-works",
    path: "/about-us/works",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/works-94940a94.js").then((m) => m.default || m)
  },
  {
    name: "auth-login",
    path: "/auth/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-fea5be3b.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/password-recovery-ad2e4af7.js").then((m) => m.default || m)
  },
  {
    name: "auth-register",
    path: "/auth/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/register-28805089.js").then((m) => m.default || m)
  },
  {
    name: "blog-detail-id",
    path: "/blog-detail/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-5bb00655.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/related-40e92588.js").then((m) => m.default || m)
  },
  {
    name: "category",
    path: "/category",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-ae33180a.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e28d8534.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/pattern-fc7bb63a.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/project-business-consultant-8565018b.js").then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-df20c89b.js").then((m) => m.default || m)
  },
  {
    name: "tag-id",
    path: "/tag/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-4b54fcfc.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  main: () => import("./_nuxt/main-73076072.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-320f564f.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-b4fd7718.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-790a2a09.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
