...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/product-and-services-39d9e530.js").then((m) => m.default || m)
  },
  {
    name: "about-us-works",
    path: "/about-us/works",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-e26691b0.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/password-recovery-288ec391.js").then((m) => m.default || m)
  },
  {
    name: "auth-register",
    path: "/auth/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/register-deafa11c.js").then((m) => m.default || m)
  },
  {
    name: "blog-detail-id",
    path: "/blog-detail/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-25233ef4.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/related-02ce11c3.js").then((m) => m.default || m)
  },
  {
    name: "category",
    path: "/category",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-6b726982.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-7f3f2d91.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  main: () => import("./_nuxt/main-38bf409a.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-93702fba.js").then((r) => r.default || r));
