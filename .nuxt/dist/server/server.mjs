...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c49b9120.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/product-and-services-9ba6848e.js").then((m) => m.default || m)
  },
  {
    name: "about-us-works",
    path: "/about-us/works",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/works-4939ed38.js").then((m) => m.default || m)
  },
  {
    name: "auth-login",
    path: "/auth/login",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-fa019391.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/password-recovery-3f0e02a7.js").then((m) => m.default || m)
  },
  {
    name: "auth-register",
    path: "/auth/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/register-6af53b1f.js").then((m) => m.default || m)
  },
  {
    name: "blog-detail-id",
    path: "/blog-detail/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-19768bfe.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/related-d5870c9b.js").then((m) => m.default || m)
  },
  {
    name: "category",
    path: "/category",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e2c714f3.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-10b543d0.js").then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-b61f4d42.js").then((m) => m.default || m)
  },
  {
    name: "tag-id",
    path: "/tag/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-7cae1f37.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  main: () => import("./_nuxt/main-fee7f521.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-1561a94b.js").then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-cfc13b7d.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
