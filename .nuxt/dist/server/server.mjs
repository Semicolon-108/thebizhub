...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-e4812c8e.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/product-and-services-191089dd.js").then((m) => m.default || m)
  },
  {
    name: "about-us-works",
    path: "/about-us/works",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-c10bd68f.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/password-recovery-f83df6f6.js").then((m) => m.default || m)
  },
  {
    name: "auth-register",
    path: "/auth/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/register-d390086b.js").then((m) => m.default || m)
  },
  {
    name: "blog-detail-id",
    path: "/blog-detail/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/biz-coaching-d7c5549a.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/biz-course-9572abeb.js").then((m) => m.default || m)
  },
  {
