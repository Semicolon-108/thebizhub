...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/login-63ca6b5e.js").then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/password-recovery-74f6dfda.js").then((m) => m.default || m)
  },
  {
    name: "auth-register",
    path: "/auth/register",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/register-c5b9164e.js").then((m) => m.default || m)
  },
  {
    name: "blog-detail-id",
    path: "/blog-detail/:id()",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-da547480.js").then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
...
const layouts = {
  main: () => import("./_nuxt/main-327ef655.js").then((m) => m.default || m)
};
