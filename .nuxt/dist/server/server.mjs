...
const _routes = [
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_id_-131910a6.js").then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-ad669a61.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-4a2794e7.js").then((m) => m.default || m)
  },
  {
    name: "search",
    path: "/search",
...
const layouts = {
  main: () => import("./_nuxt/main-5c08aa69.js").then((m) => m.default || m)
};
